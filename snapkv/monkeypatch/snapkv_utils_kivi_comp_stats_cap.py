...
class SnapKVClusterKIVI:
    ...
    def reset(
        ...
        self.__init__(window_size, max_capacity_prompt, kernel_size, pooling, kivi_bits, kivi_group_size, keep_dropped_quant, kivi_max_capacity)
    ...
    def update_kv(self, key_states, query_states, value_states, attention_mask, num_key_value_groups):
        ...
        if self.keep_dropped_quant:
            ...
            if max_drop != 0:
                ...
                # Build dropped indices in original token order. This matters when a KIVI capacity is set:
                # exceeding capacity discards the oldest dropped tokens and keeps the newest ones.
                ...
                drop_idx = torch.sort(drop_rank, dim=-1).values[..., :drop_len]  # ascending original positions

                if max_drop > 0 and drop_len > max_drop:
                    drop_idx = drop_idx[..., -max_drop:]
                    drop_len_kept = max_drop
                else:
                    drop_len_kept = drop_len
